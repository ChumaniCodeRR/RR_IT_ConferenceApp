...
namespace ConferenceSys
{
    public partial class Reports : Form
    {
        ...
        public Reports(bool _isNAf,string dowhat, DataView _dv_report, string _title)
        {
            InitializeComponent();
            action = dowhat;
        ...
        public Reports(string dowhat, DataView _dv_report, string _title, bool showStuDetails)
        {
            InitializeComponent();
            action = dowhat;
            dv_report = _dv_report;
            title = _title;
            isStudent = showStuDetails;
        }
        ...
        private void Reports_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (action == "FullReservationReport") parameters = 2;
                ...
                if (action == "RoomNights")
                {

                    rds.Name = "ds_report";
                    rds.Value = dv_report;
                    reportViewer1.LocalReport.ReportEmbeddedResource = string.Concat(rootNamespace, ".Reports.ConferenceWardens.RoomNights.rdlc");
                    p[0] = new Microsoft.Reporting.WinForms.ReportParameter("title", this.title);
                ...
                if (action == "ConfirmationLetter")
                {
                    ...
                    rds.Name = "ds_report";
                    rds.Value = dv_report;
                    if (isNAf) reportViewer1.LocalReport.ReportEmbeddedResource = string.Concat(rootNamespace, ".Reports.ConferenceWardens.NAFConfirmLetter.rdlc");
                    else reportViewer1.LocalReport.ReportEmbeddedResource = string.Concat(rootNamespace, ".Reports.ConferenceWardens.ConfirmationLetter.rdlc");
                ...
                if (action == "NSFASLIST")
                {
                    rds.Name = "ds_report";
                    rds.Value = dv_report;
                    reportViewer1.LocalReport.ReportEmbeddedResource = string.Concat(rootNamespace, ".Reports.NSFASConferences.NSFASLIST.rdlc");
                    p[0] = new Microsoft.Reporting.WinForms.ReportParameter("title", title);
                }
                ...
                if (action == "FullReservationReport")
                {
                    rds.Name = "ds_report";
                    rds.Value = dv_report;
                    reportViewer1.LocalReport.ReportEmbeddedResource = string.Concat(rootNamespace, ".Reports.ConferenceWardens.FullReservationReport.rdlc");
                    p[0] = new Microsoft.Reporting.WinForms.ReportParameter("title", title);
                    p[1] = new Microsoft.Reporting.WinForms.ReportParameter("isStudent", isStudent.ToString());
                }  
