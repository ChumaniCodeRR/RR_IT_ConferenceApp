...
namespace ConferenceSys
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (validlogin)
                {
                    ...
                    writeOffToolStripMenuItem.Visible = Utilities.AccessControl.HasManager;
        ...
        {
            // make fincore if statement 
            if (Global.Global.fincore_status == true)
            {
                ConferenceSys.ConferenceAdmin.ConferenceUpdate.FinCoreConferenceUpdate frm_fincore_conference = new ConferenceAdmin.ConferenceUpdate.FinCoreConferenceUpdate();
                frm_fincore_conference.ShowDialog();

            }
            else if (Global.Global.fincore_status == false)
            {
            ...
            try
            {
                ...
                if (frmSearch.Stuno != "")
                {
                    ...
                    if (ds_bookings.tt_bookings.Count > 0)
                    {
                        ...
                        Reports frmReport = new Reports(false,"StuBookings", dv_report, tempstring);
                        frmReport.Show();
                    }
        ...
        private void conferenceRoomsReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ds_report.tt_rooms_report.Count > 0)
            {
                ...
                Reports frmReports = new Reports(false, "RoomsReport", dvData, "Conference Rooms");
                frmReports.Show();
            }
        ...
        private void blockedRoomsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ds_report.TT_ROOMS.Count > 0)
            {
                ...
                Reports frmReports = new Reports(false, "BlockedReport", dvData, "Blocked Room Report");
                frmReports.Show();
            }
            else MessageBox.Show("Error - There is no data to display", "Error No Data", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void conferenceAvailableRoomsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConferenceWardens.ConferenceAvaialbleRooms frm_available = new ConferenceWardens.ConferenceAvaialbleRooms();
            frm_available.ShowDialog();
        }

        
        private void approvePaymentOverrideRequestsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConferenceSys.ConferenceAdmin.ConferenceUpdate.ApproveOverride frmApprove = new ConferenceAdmin.ConferenceUpdate.ApproveOverride();
            frmApprove.ShowDialog();
        }

        private void setConferenceFullIndicatorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConferenceSys.ConferenceAdmin.ConferenceUpdate.FullConferences frmFull = new ConferenceSys.ConferenceAdmin.ConferenceUpdate.FullConferences();
            frmFull.ShowDialog();
        }

        private void captureRecieptToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            ConferenceSys.ConferenceAdmin.Conference_Updates.Capture_Reciept frmReciept = new ConferenceAdmin.Conference_Updates.Capture_Reciept(string.Empty, -1);
            frmReciept.ShowDialog();
        }

        private void conferenceBedNightsReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConferenceSys.ConferenceWardens.BedNightsReport frmBeds = new ConferenceWardens.BedNightsReport();
            frmBeds.ShowDialog();
        }

        private void writeOffToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConferenceSys.ConferenceAdmin.Conference_Updates.Writeoff frmWriteoff = new ConferenceAdmin.Conference_Updates.Writeoff();
            frmWriteoff.ShowDialog();
        }

        private void conferenceRoomsOccupancyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConferenceSys.ConferenceWardens.RoomsNightReport frmRooms = new ConferenceWardens.RoomsNightReport();
            frmRooms.ShowDialog();
        }

        private void folioToolStripMenuItem_Click(object sender, EventArgs e)
        {
            IOPS.ConferenceAdmin.Utilities.FolioLookUp frmLookUp = new IOPS.ConferenceAdmin.Utilities.FolioLookUp();
